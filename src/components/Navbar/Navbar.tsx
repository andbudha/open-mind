...
const navbar = {
  ...
  logo_box: `h-20 w-48 flex justify-start items-center text-3xl italic tracking-wider text-[#FC6736] `,
  logo: `pl-10`,
  btn_box: `pr-10 h-20 w-[500px] flex items-center justify-end w-full italic tracking-wider text-[#FC6736] `,
  ...
  return (
    <div className={navbar.main}>
      ...
      <div className={navbar.btn_box}>
        ...
        <NavLink to="blogform" className={navbar.btn}>
          <div>add blog </div>
