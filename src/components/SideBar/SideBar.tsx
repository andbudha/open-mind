...
const styles = {
  ...
  btn: `py-2 px-4 flex justify-end items-center rounded cursor-pointer mb-2  w-34 bg/-[#fff] transition ease-in-out hover:-translate-y-1 hover:scale-110 hover: duration-300`,
  icon: `ml-2 h-5 w-5`,
};
